...
const ServiceCard = ({ image, title, description, price, slug }: ServiceCardProps) => {
  return (
    <div className="group bg-gradient-card rounded-xl overflow-hidden gold-border hover-gold-glow transition-all duration-500 hover:-translate-y-2">
